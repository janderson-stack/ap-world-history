(() => {
  ...
  lesson.first10 = {
    ...
    embedUrl: 'first-and-10-topic-1-1-song-china.html',
    note: 'Use the embedded rich narrative reading window below, then close this pop-out to return to the 1.1 lesson path.'
  };
